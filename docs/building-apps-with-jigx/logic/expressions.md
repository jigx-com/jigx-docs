...
* Use _F12_ to navigate from an expression to the JavaScript function script file. See [Go to Definition](../jigx-builder-code-_editor_/editor.md#definition-f12).
* From the script file use _shift + F12_ or right-click and select [Go to References](../jigx-builder-code-_editor_/editor.md#references-shiftf12) to see where all the script file is used in expressions.
