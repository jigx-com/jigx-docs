...
* [User Profile](https://docs.jigx.com/examples/readme/user-profile)
* [Solution switching](<../../../Understanding the basics/Jigx Concepts.md>)
* Tabs in [Index settings](index-settings.md)
* [grid](https://docs.jigx.com/examples/readme/components/grid) and [grid-item](https://docs.jigx.com/examples/readme/components/grid/grid-item)
...
* Setting the [grid](https://docs.jigx.com/examples/readme/components/grid) jig as the first tab's jig creates a visually appealing and easy-to-navigate home screen.&#x20;

### grid and grid-item

* The [grid](https://docs.jigx.com/examples/readme/components/grid) and [grid-item](https://docs.jigx.com/examples/readme/components/grid/grid-item) are available in 5 different `sizes`: 1x1, 2x2, 4x2, 2x4, and 4x4.
...
* Within the grid-item you can select to show [widgets](https://docs.jigx.com/examples/readme/widgets), an [image](https://docs.jigx.com/examples/readme/components/image), and [Custom Components (Alpha)](../custom-components-_alpha_/custom-components-_alpha_.md).
